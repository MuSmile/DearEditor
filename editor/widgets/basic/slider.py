...
class RangeSlider(QtWidgets.QSlider):
    sliderMoved2 = QtCore.Signal(int, int)
    ...
    def mouseMoveEvent(self, event):
        ...
        #self.emit(QtCore.SIGNAL('sliderMoved2(int)'), new_pos)
        self.sliderMoved2.emit(self._low, self._high)
...
if __name__ == "__main__":
    ...
    slider.sliderMoved2.connect(echo)
    #QtCore.QObject.connect(slider, QtCore.SIGNAL('sliderMoved2(int)'), echo)
    slider.show()
    slider.raise_()
    app.exec()