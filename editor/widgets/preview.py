...
from PySide6.QtCore import Qt, QSize, QRect, QDate, QTime, QDateTime
from PySide6.QtGui import (QIcon, QPen, QBrush, QPixmap, QPainter, QLinearGradient, QRadialGradient, QConicalGradient,
...
class PreviewWidget(QTabWidget):
    ...
    def setupTab4(self, tab4):
        ...
        d1.setFeatures(QDockWidget.DockWidgetVerticalTitleBar)
